    ...
    <div>
      <div className="container flex flex-col bg-zinc-800 px-6 py-12 gap-8 mx-auto">
        ...
        <div className="icons flex flex-wrap gap-6 justify-around align-center md:mx-auto">
          <Motion animation="swipeUp" delay="0" >
          ...
          <Motion animation="swipeUp" delay="0.1" >
          ...
          <Motion animation="swipeUp" delay="0.2" >
          ...
          <Motion animation="swipeUp" delay="0.3" >
          ...
          <Motion animation="swipeUp" delay="0.4" >
